nomes = ['João', 'Maria', 'Pedro', 'Ana', 'Carlos', 'Mariana', 'José', 'Beatriz', 'Antônio', 'Laura',
...
nomedigitado = str(input('Insira um nome:'))

if nomedigitado in nomes:
    print(f'O nome {nomedigitado} está na lista.')
else:
